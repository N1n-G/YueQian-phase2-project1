...
{
    lv_obj_set_style_bg_color(color, lv_palette_main(LV_PALETTE_PURPLE), 0);           // 设置起始颜色
    lv_obj_set_style_bg_grad_color(color, lv_palette_darken(LV_PALETTE_YELLOW, 3), 0); // 设置结束颜色
